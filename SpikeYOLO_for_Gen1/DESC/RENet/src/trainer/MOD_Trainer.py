...
from MOD_utils.utils import AverageMeter


class MODTrainLoss(torch.nn.Module):
    def __init__(self, opt):
        super(MODTrainLoss, self).__init__()
...
class MODTrainer(object):
    def __init__(self, opt, model, optimizer=None):
        ...
        self.model_with_loss = ModleWithLoss(model, MODTrainLoss(opt))
